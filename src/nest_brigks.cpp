...
bool sort(const double& d1, const double& d2)
{
  return d1 > d2;
}
...
XSIPLUGINCALLBACK CStatus XSILoadPlugin( PluginRegistrar& in_reg )
{
   ...
   in_reg.PutName(L"nest_brigks_Plugin");
   in_reg.PutEmail(L"");
   in_reg.PutURL(L"");
   in_reg.PutVersion(1,3);

   // register all of the solvers
   in_reg.RegisterOperator(L"nest_xfspring_op");
   in_reg.RegisterOperator(L"nest_rotspring_op");
   in_reg.RegisterOperator(L"nest_ik2bone_op");
   in_reg.RegisterOperator(L"nest_ikfk2bone_op");
   in_reg.RegisterOperator(L"nest_splinekine_op");
   in_reg.RegisterOperator(L"nest_rollsplinekine_op");
   in_reg.RegisterOperator(L"nest_interpose_op");
   in_reg.RegisterOperator(L"nest_squashstretch_op");
   in_reg.RegisterOperator(L"nest_iso4point_op");
   in_reg.RegisterOperator(L"nest_null2curve_op");
   in_reg.RegisterOperator(L"nest_null2surface_op");
   in_reg.RegisterOperator(L"nest_curveslide_op");
   in_reg.RegisterOperator(L"nest_autoweighting_op");

   // register all of the properties
   in_reg.RegisterProperty(L"nest_ik2bone_prop");
   in_reg.RegisterProperty(L"nest_ikfk2bone_prop");
   in_reg.RegisterProperty(L"nest_splinekine_prop");
   in_reg.RegisterProperty(L"nest_squashstretch_prop");
...
XSIPLUGINCALLBACK CStatus nest_xfspring_op_Define( CRef& in_ctxt )
{
...
XSIPLUGINCALLBACK CStatus nest_xfspring_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_xfspring_op_Update( CRef& in_ctxt )
{
...
XSIPLUGINCALLBACK CStatus nest_rotspring_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_rotspring_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_rotspring_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
...
XSIPLUGINCALLBACK CStatus nest_ik2bone_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_ik2bone_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
CTransformation nest_GetIKTransform(s_nest_GetIKTransform values)
{
...
XSIPLUGINCALLBACK CStatus nest_ik2bone_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
   ...
   CTransformation ikXF = nest_GetIKTransform(params);
...
XSIPLUGINCALLBACK CStatus nest_ikfk2bone_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_ikfk2bone_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
CTransformation nest_GetFKTransform(s_nest_GetFKTransform values)
{
   // prepare all variables
   CTransformation result;
...
XSIPLUGINCALLBACK CStatus nest_ikfk2bone_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
   //KinematicState parentKine = ctxt.GetInputValue(0);
   ...
   s_nest_GetIKTransform ikparams;
   ...
   s_nest_GetFKTransform fkparams;
   ...
   CTransformation result;
   if(blend == 0.0)
      result = nest_GetIKTransform(ikparams);
   else if(blend == 1.0)
      result = nest_GetFKTransform(fkparams);
   else
   {
      // here is where the blending happens!
      ikparams.mode = 0;
      CTransformation ikbone1 = nest_GetIKTransform(ikparams);
      ikparams.mode = 1;
      CTransformation ikbone2 = nest_GetIKTransform(ikparams);
      ikparams.mode = 4;
      CTransformation ikeff = nest_GetIKTransform(ikparams);
...
XSIPLUGINCALLBACK CStatus nest_splinekine_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_splinekine_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_splinekine_op_Update( CRef& in_ctxt )
{
   return splinekine_op_Update(in_ctxt,0);
}

XSIPLUGINCALLBACK CStatus nest_rollsplinekine_op_Define( CRef& in_ctxt )
{
   return nest_splinekine_op_Define( in_ctxt );
}

XSIPLUGINCALLBACK CStatus nest_rollsplinekine_op_DefineLayout( CRef& in_ctxt )
{
   return nest_splinekine_op_DefineLayout(in_ctxt);
}

XSIPLUGINCALLBACK CStatus nest_rollsplinekine_op_Update( CRef& in_ctxt )
{
   return splinekine_op_Update(in_ctxt,1);
}

XSIPLUGINCALLBACK CStatus nest_ik2bone_prop_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
...
XSIPLUGINCALLBACK CStatus nest_ik2bone_prop_DefineLayout( CRef& in_ctxt )
{
   return nest_ik2bone_op_DefineLayout(in_ctxt);
}

XSIPLUGINCALLBACK CStatus nest_ikfk2bone_prop_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomProperty oCustomProperty;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_ikfk2bone_prop_DefineLayout( CRef& in_ctxt )
{
   return nest_ikfk2bone_op_DefineLayout(in_ctxt);
}

XSIPLUGINCALLBACK CStatus nest_splinekine_prop_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomProperty oCustomProperty;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_splinekine_prop_DefineLayout( CRef& in_ctxt )
{
   return nest_splinekine_op_DefineLayout(in_ctxt);
}

XSIPLUGINCALLBACK CStatus nest_interpose_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_interpose_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_interpose_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
...
XSIPLUGINCALLBACK CStatus nest_squashstretch_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_squashstretch_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_squashstretch_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
   KinematicState parentKine = (CRef)ctxt.GetInputValue(0);
   CTransformation parentXF = parentKine.GetTransform();
...
XSIPLUGINCALLBACK CStatus nest_squashstretch_prop_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomProperty oCustomProperty;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_squashstretch_prop_DefineLayout( CRef& in_ctxt )
{
   return nest_squashstretch_op_DefineLayout(in_ctxt);
}

XSIPLUGINCALLBACK CStatus nest_iso4point_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_iso4point_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_iso4point_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
   double u = ctxt.GetParameterValue(L"u");
...
XSIPLUGINCALLBACK CStatus nest_null2curve_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_null2curve_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_null2curve_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
   double blend = ctxt.GetParameterValue(L"blend");
   double u = ctxt.GetParameterValue(L"u");
...
XSIPLUGINCALLBACK CStatus nest_null2surface_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_null2surface_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_null2surface_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
...
XSIPLUGINCALLBACK CStatus nest_null2surface_op_PPGEvent( const CRef& in_ctxt )
{
...
XSIPLUGINCALLBACK CStatus nest_curveslide_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
...
XSIPLUGINCALLBACK CStatus nest_curveslide_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
...
XSIPLUGINCALLBACK CStatus nest_curveslide_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
...
XSIPLUGINCALLBACK CStatus nest_autoweighting_op_Define( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   CustomOperator oCustomOperator;
   Parameter oParam;
   ...
   Factory oFactory = Application().GetFactory();
   oCustomOperator = ctxt.GetSource();
   oPDef = oFactory.CreateParamDef(L"smooth",CValue::siDouble,siPersistable | siAnimatable,L"",L"",1,0,1,0,1);
   oCustomOperator.AddParameter(oPDef,oParam);
   oPDef = oFactory.CreateParamDef(L"roundness",CValue::siDouble,siPersistable | siAnimatable,L"",L"",0,0,1,0,1);
   oCustomOperator.AddParameter(oPDef,oParam);
   oPDef = oFactory.CreateParamDef(L"distance",CValue::siDouble,siPersistable | siAnimatable,L"",L"",1,0.001,1000000,0.001,10);
   oCustomOperator.AddParameter(oPDef,oParam);
   oPDef = oFactory.CreateParamDef(L"maxcount",CValue::siInt4,siPersistable | siAnimatable,L"",L"",2,1,10000,1,5);
   oCustomOperator.AddParameter(oPDef,oParam);
   oPDef = oFactory.CreateParamDef(L"blend",CValue::siDouble,siPersistable | siAnimatable,L"",L"",1,0,1,0,1);
   oCustomOperator.AddParameter(oPDef,oParam);
   oPDef = oFactory.CreateParamDef(L"zero",CValue::siBool,siPersistable | siAnimatable,L"",L"",0,0,1,0,1);
   oCustomOperator.AddParameter(oPDef,oParam);
   oPDef = oFactory.CreateParamDef(L"count",CValue::siInt4,siPersistable | siReadOnly,L"",L"",1,1,10000,1,1000);
   oCustomOperator.AddParameter(oPDef,oParam);
...
XSIPLUGINCALLBACK CStatus nest_autoweighting_op_DefineLayout( CRef& in_ctxt )
{
   Context ctxt( in_ctxt );
   PPGLayout oLayout;
   PPGItem oItem;
   oLayout = ctxt.GetSource();
   oLayout.Clear();
   oLayout.AddItem(L"smooth",L"Smooth");
   oLayout.AddItem(L"roundness",L"Spherical");
   oLayout.AddItem(L"distance",L"Max Distance");
   oLayout.AddItem(L"maxcount",L"Max Deformers");
   oLayout.AddItem(L"blend",L"Blend");
   oLayout.AddItem(L"zero",L"Allow Zero Weight");
   return CStatus::OK;
}

XSIPLUGINCALLBACK CStatus nest_autoweighting_op_Update( CRef& in_ctxt )
{
   OperatorContext ctxt( in_ctxt );
   double smooth = ctxt.GetParameterValue(L"smooth");
   double nsmooth = 1.0 - smooth;
   double roundness = ctxt.GetParameterValue(L"roundness");
   double nroundness = 1.0 - roundness;
   double distance = ctxt.GetParameterValue(L"distance");
   distance = max(distance,0.001);
   double blend = ctxt.GetParameterValue(L"blend");
   bool zero = ctxt.GetParameterValue(L"zero");
   double nblend = 1.0 - blend;
   LONG count = ctxt.GetParameterValue(L"count");
   LONG maxcount = ctxt.GetParameterValue(L"maxcount");

   LONG portOffset = 0;
   Primitive meshPrim = (CRef)ctxt.GetInputValue(portOffset++);
   Geometry meshGeo(meshPrim.GetGeometry());
   CPointRefArray meshPnts(meshGeo.GetPoints());
   ClusterProperty weightProp = (CRef)ctxt.GetInputValue(portOffset++);
   CDoubleArray originalWeights = weightProp.GetElements().GetArray();
   
   std::vector<CTransformation> XFs;
   CTransformation currentXF,compensateXF;
   CVector3 s;
   for(LONG i=0;i<count;i++)
   {
      // access the deformers' kinestates + primitives
      Primitive nullPrim = (CRef)ctxt.GetInputValue(portOffset++);
      StaticKinematicState nullKineState = (CRef)ctxt.GetInputValue(portOffset++);
      currentXF = nullKineState.GetTransform();
      
      // add translation and scaling to the transform if we use a null
      if(nullPrim.GetType().IsEqualNoCase(L"null"))
      {
         double posX = nullPrim.GetParameterValue("shadow_offsetX");
         double posY = nullPrim.GetParameterValue("shadow_offsetY");
         double posZ = nullPrim.GetParameterValue("shadow_offsetZ");
         double size = nullPrim.GetParameterValue("size");
         size *= 2.0;
         double sclX = nullPrim.GetParameterValue("shadow_scaleX");
         double sclY = nullPrim.GetParameterValue("shadow_scaleY");
         double sclZ = nullPrim.GetParameterValue("shadow_scaleZ");
         compensateXF.SetTranslationFromValues(posX,posY,posZ);
         compensateXF.SetScalingFromValues(sclX*size,sclY*size,sclZ*size);

         currentXF.Mul(compensateXF,currentXF);
      }

      // reproject the distance into the scaling
      s = currentXF.GetScaling();
      s.ScaleInPlace(distance);
      currentXF.SetScaling(s);
   ...
   CVector3Array pos = meshPnts.GetPositionArray();
   CLongArray defCountPos(pos.GetCount());
   CDoubleArray weightSum(pos.GetCount());
   CDoubleArray weights(pos.GetCount() * count);
   LONG weightOffset = 0;
   LONG weightOffsetTmp;
   CVector3 v;
   double cubeWeight,sphereWeight,weight;
   double maxWeight;
   LONG maxIndex;
   for(LONG i=0;i<pos.GetCount();i++)
   {
      ...
      // loop for the first time to find all weights
      weightOffsetTmp = weightOffset;
      for(LONG j=0;j<count;j++)
      {
         weight = 0.0;

         v = MapWorldPositionToObjectSpace(XFs[j],pos[i]);
         
         // calculate both positive weights, be lazy about it,
         // both are expensive to calculate
         if(roundness < 1.0)
         {
            v.PutX(fabs(v.GetX()));
            v.PutY(fabs(v.GetY()));
            ...
            if(v.GetX() <= 1.0 && v.GetY() <= 1.0 && v.GetZ() <= 1.0)
               cubeWeight = 1.0 - (1.0 - v.GetX()) * (1.0 - v.GetY()) * (1.0 - v.GetZ());
            else
               cubeWeight = v.GetLength();
         }
         else
            cubeWeight = 0.0;
         if(roundness > 0.0)
            sphereWeight = v.GetLength();
         else
            sphereWeight = 0.0;
            
         // blend cube and sphere
         weight = roundness * sphereWeight + nroundness * cubeWeight;

         // store for autoweighting to something at least to the max!
         if(weight < maxWeight)
         {
            maxIndex = j;
            maxWeight = weight;
         ...
         // invert the weight
         weight = clamp(1.0 - weight,0,1);

         // if we found a weight, increase the count!
         if(weight > 0.0)
         {
            defCountPos[i]++;
            weight = smooth * smoothstep2(weight) + nsmooth * weight;
            weightSum[i] += weight;
         }
      ...
      // loop for the second time for normalization
      weightOffset = weightOffsetTmp;
      if(defCountPos[i] > 0)
      {
         // if we have a limit on the deformers, we need to find the highest ones!
         if(maxcount < defCountPos[i])
         {
            // the first time we have to loop to find the largest one
            std::vector<double> weightSort;
            weightSort.resize(count);
            for(LONG j=0;j<count;j++)
            {
               weightSort[j] = weights[weightOffset];
               weightOffset++;
            }
            std::sort(weightSort.begin(), weightSort.end(),sort);
            weightSum[i] = 0.0;

            // now remove all the ones and update the sum for normalization
            double lastOne = weightSort[maxcount-1];
            weightOffset = weightOffsetTmp;
            for(LONG j=0;j<count;j++)
            {
               if(weights[weightOffset] >= lastOne)
                  weightSum[i] += weights[weightOffset];
               else
                  weights[weightOffset] = 0.0;
               weightOffset++;
            }
         }
         
         // this we do if we found a deformer using this point
         weightOffset = weightOffsetTmp;
         for(LONG j=0;j<count;j++)
         {
            if(weights[weightOffset]<0)
            {
               weights[weightOffset] = nblend * originalWeights[weightOffset];
            }
            else
            {
               // needs to be multiplied by 100 since we are looking at percentage values
               if(weightSum[i] == 0.0)
                  weights[weightOffset] = nblend * originalWeights[weightOffset];
               else
                  weights[weightOffset] = blend * 100.0 * weights[weightOffset] / weightSum[i] + nblend * originalWeights[weightOffset];
            }
            weights[weightOffset] = clamp(weights[weightOffset],0,100);
            weightOffset++;
         }      
      }
      else if(!zero)
      {
         // if we don't have any deformer in range, let's just the closest one
         for(LONG j=0;j<count;j++)
         {
            // needs to be multiplied by 100 since we are looking at percentage values
            if(j==maxIndex)
               weights[weightOffset] = blend * 100.0 + nblend * originalWeights[weightOffset];
            else
               weights[weightOffset] = nblend * originalWeights[weightOffset];
            weights[weightOffset] = clamp(weights[weightOffset],0,100);
            weightOffset++;
   ...
   ClusterProperty outWeightProp(ctxt.GetOutputTarget());
   outWeightProp.GetElements().PutArray(weights);
